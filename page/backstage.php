...
<body style="overflow: hidden;">
    <mdui-layout>
        ...
        <mdui-navigation-rail contained divider>
            <mdui-navigation-rail-item icon="dashboard" href="/sw-ad/">主面板</mdui-navigation-rail-item>
            <mdui-navigation-rail-item icon="api" href="/sw-ad/api">API管理</mdui-navigation-rail-item>
            <mdui-navigation-rail-item icon="settings" href="/sw-ad/settings">设置</mdui-navigation-rail-item>
            <mdui-navigation-rail-item icon="edit_note" href="/sw-ad/web">修改信息</mdui-navigation-rail-item>
            <mdui-navigation-rail-item icon="edit_note" href="/sw-ad/log">日志查看</mdui-navigation-rail-item>
